// Tamamlanmış ve Düzeltilmiş Kod
...
const FALLBACK_MISSIONS = [
    ...
    "Polise yakalanmadan 2 dakika boyunca hayatta kal.",

    "Canin %50'nin altina dusmeden Sehir Merkezi'ne ulas.",

    "Sehirdeki 3 heykeli yok et.",

    "Trafikteki 5 araca carparak kaos yarat.",

    "Polis arabasini 3 baska araca carptirarak buyuk bir kaza yaptir.",

    "Okyanus Kenari yolunda 30 saniye boyunca son surat ilerle."

].map(turkishToEnglish);

const FALLBACK_CHATTER = [

    "Merkez, supheli Ocean Drive'da guneye dogru ilerliyor.",

    "Tum birimlere: Kirmizi spor araba takibe alindi, destek bekleniyor.",

    "Supheli Downtown bolgesinde goruldu, asiri hiz yapiyor.",

    "Dikkat, supheli tehlikeli manevralar yapiyor. Dikkatli yaklasin.",

    "Takip devam ediyor, supheli Starfish Adasi'na yoneldi."
...
const dayCycleParameters = {
    ...
    NIGHT: {
        ...
        fog: new THREE.Color(0x3a4a6a),

        hemiSky: new THREE.Color(0xcceeff),

        hemiGround: new THREE.Color(0x556688),
    ...
    MORNING: {
        ...
        background: new THREE.Color(0xf7b267),

        fog: new THREE.Color(0xe5989b),

        hemiSky: new THREE.Color(0xf7b267),

        hemiGround: new THREE.Color(0xc06c84),

        dirLight: new THREE.Color(0xffaa00),
    ...
    PRE_NOON: {
        ...
        fog: new THREE.Color(0xa0dae9),

        hemiSky: new THREE.Color(0xadd8e6),

        hemiGround: new THREE.Color(0xa9a9a9),
    ...
    NOON: {
        ...
        hemiGround: new THREE.Color(0xcccccc),
    ...
    AFTERNOON: {
        ...
        background: new THREE.Color(0xa0d8e9),

        fog: new THREE.Color(0xb0c7db),

        hemiSky: new THREE.Color(0xf5f5dc),

        hemiGround: new THREE.Color(0xb0c7db),

        dirLight: new THREE.Color(0xffdd88),
    ...
    EVENING: {
        ...
        background: new THREE.Color(0xff4e50),

        fog: new THREE.Color(0xff8c42),

        hemiSky: new THREE.Color(0xff6f61),

        hemiGround: new THREE.Color(0x6b5b95),

        dirLight: new THREE.Color(0xff6600),
...
const phaseDuration = dayCycleTime / dayCyclePhases.length;

let currentCycleTime = 0;

const MENU_VOLUME = 0.6;

const RADIO_VOL_MAX = 0.6;

const RADIO_VOL_MIN = 0.3;

const ENGINE_VOL_MAX = 0.4;

const ENGINE_VOL_MIN = 0.1;

const SIREN_VOLUME = 0.5;

let scene, camera, renderer, clock;

let player, policeCar = null,

    sirenLightRed, sirenLightBlue, road;
...
let lastPoliceShotTime = 0,

    wantedLevelCooldown = 0,
...
const BOOST_CHARGE_TIME = 20,

    BOOST_DURATION = 3.5,

    BOOST_SPEED_MULTIPLIER = 1.6;

let cleanDrivingTime = 0,
...
let nextChatterTime = 20,

    nextMissionPromptTime = 30,

    nextSpeechBubbleTime = 0;

const CHATTER_INTERVAL = 25,

    MISSION_PROMPT_INTERVAL = 45;

let missionHideTimeout = null,
...
function loadSounds() {
    ...
    sounds = {
        ...
        engine: new Howl({
            ...
            src: ['sound/engine_sound.ogg'],

            loop: true,

            volume: ENGINE_VOL_MIN,
        ...
        radio: new Howl({
            ...
            src: ['sound/Vice City Geceleri.mp3'],
...
function createPlayer() {
    ...
    const createWheel = () => {
        ...
        const w = new THREE.Mesh(wheelGeom, wheelMaterial);
    ...
    const wFL = createWheel();

    wFL.position.set(-1.6, 0.5, -2.0);

    const wFR = createWheel();

    wFR.position.set(1.6, 0.5, -2.0);

    const wBL = createWheel();

    wBL.position.set(-1.6, 0.5, 2.0);

    const wBR = createWheel();

    wBR.position.set(1.6, 0.5, 2.0);
...
function createPoliceCar() {
    ...
    const blackTrimMaterial = new THREE.MeshPhongMaterial({
    ...
    const sirenLightGeo = new THREE.BoxGeometry(0.5, 0.25, 